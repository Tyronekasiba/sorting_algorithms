...
/**
 * * mergesort_topdown_merge - Merge two partitions during a mergesorting.
 * * @array: Array to  be sort
 * * @result_array: Temporary array to store results_array
...
/**
 * * mergesort_topdown_split - Perform merge sort on an array partitions
 * * @array: Array to be sort
...
/**
 * * merge_sort - Sorts an array using the Merge Sorting  method
